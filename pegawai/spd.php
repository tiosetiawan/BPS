                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                   			      ...
                   			      $tampil=mysql_query("SELECT spd.nosurat, spd.komitmen, spd.lamap,spd.namakomitmen, pegawai.nama, spd.tb, spd.tk, anggaran.uraian, spd.mp ,anggaran.hargasat from pegawai, anggaran, spd where pegawai.nip=spd.nip and anggaran.kode=spd.kode and username='$username'");
