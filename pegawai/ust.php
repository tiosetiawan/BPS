                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Tanggal Upload Surat Tugas</th>
                                            <th>Action</th>
                                     ...
                                     $tampil=mysql_query("SELECT uploadst.nosurat, uploadst.tgl_upload, pegawai.username, uploadst.nip, pegawai.nama, uploadst.komitmen,uploadst.nama_file from uploadst, pegawai where uploadst.nip=pegawai.nip and username='$username'");
